            ...
            <ul>
                <li>
                    <div class="container">
                        ...
                        <h1 class="aligncenter">　<%=Resources.Resource.Introduction %>					
                        </h1>
                        <p>&nbsp;</p>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContent" runat="server">
    <div class="fourcol column">
        ...
        <h2 class="aligncenter alignvertical"><%=Resources.Resource.Guideline %>	</h2>
        <p class="aligncenter alignvertical">
            <%=Resources.Resource.BriefGuideLine%>
        </p>
    </div>
    <div class="fourcol column">
        <img class="aligncenter" src="../assets/img/icon-1.png" alt="" /><br />
        <h2 class="aligncenter alignvertical"><%=Resources.Resource.JapanShopping %></h2>
        <p class="aligncenter alignvertical">
            <ul>
                <li>
    ...
    <div class="fourcol column last">
        ...
        <h2 class="aligncenter alignvertical"><%=Resources.Resource.OtherService %></h2>
        <p class="aligncenter alignvertical">
            <ul>
                <li>
                    <a href="http://www.onnetsu.mn"><%=Resources.Resource.Onnetsu %></a>
                </li>
                <li>
                    <%=Resources.Resource.FishService %>
                </li>
                <li>
                    <%=Resources.Resource.AutoParts %>
                </li>
            </ul>
        </p>
    </div>
